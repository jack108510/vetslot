...
const CLINICS = [
  {
    id: 'clinic-1',
    name: 'Prairie Paws Veterinary Clinic',
    shortName: 'Prairie Paws Vet',
    email: 'info@prairiepawsvet.ca',
    phone: '(403) 555-0142',
    address: '124 Centre St SW',
    city: 'Calgary',
    province: 'AB',
    description: 'Full-service veterinary clinic serving Calgary families. Our surgical team has completed thousands of spay and neuter procedures with outstanding outcomes.',
  ...
  },
  {
    ...
    shortName: 'Lakeview Animal Hospital',
    email: 'reception@lakeviewanimalhospital.ca',
    phone: '(416) 555-0278',
    address: '500 King St W',
    city: 'Toronto',
    province: 'ON',
    description: 'Modern veterinary care serving Toronto families for over 15 years. Compassionate, evidence-based medicine with state-of-the-art surgical facilities.',
  ...
  {
    id: 'clinic-3',
    name: 'Westcoast Pet Care Clinic',
    shortName: 'Westcoast Pet Care',
    email: 'hello@westcoastpetcare.ca',
    phone: '(604) 555-0391',
    address: '300 Granville St',
    city: 'Vancouver',
    province: 'BC',
    description: 'Compassionate, affordable veterinary care for Vancouver families. We specialize in high-volume spay/neuter programs to help reduce pet overpopulation across BC.',
