...
const CLINICS = [
  {
    id: 'clinic-1',
    name: 'Bridgeland Animal Hospital',
    shortName: 'Bridgeland Animal Hospital',
    email: 'info@bridgelandvet.ca',
    phone: '(403) 555-0142',
    address: '811 1 Ave NE',
    city: 'Calgary',
    province: 'AB',
    description: 'Full-service veterinary clinic in the heart of Calgary\'s Bridgeland neighbourhood. Our surgical team has completed thousands of spay and neuter procedures with outstanding outcomes.',
  ...
  {
    id: 'clinic-2',
    name: 'Kensington Vet Clinic',
    shortName: 'Kensington Vet',
    email: 'reception@kensingtonvet.ca',
    phone: '(416) 555-0278',
    address: '284 Bloor St W',
    city: 'Toronto',
    province: 'ON',
    description: 'Modern veterinary care in Toronto\'s Annex neighbourhood. We\'ve been serving the community for over 15 years with compassionate, evidence-based medicine and state-of-the-art surgical facilities.',
  ...
  },
  {
    ...
    shortName: 'Kitsilano Animal Clinic',
    email: 'hello@kitsvet.ca',
    phone: '(604) 555-0391',
    address: '2096 W 4th Ave',
    city: 'Vancouver',
    province: 'BC',
    description: 'Compassionate, affordable veterinary care for Vancouver\'s west side. We specialize in high-volume spay/neuter programs to help reduce pet overpopulation across BC.',
